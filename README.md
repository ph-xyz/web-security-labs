...
Small local labs I used to study web security concepts through hands-on testing.

The lab applications were generated with AI and reviewed and tested by me for study purposes.
...
Each folder contains its own setup instructions. These applications are intentionally vulnerable and must only be run locally or in authorized environments.
